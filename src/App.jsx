  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-[#e0d4f7] via-[#fbe5f0] to-[#fef6e5]">
        {/* !!!!!!!!!!!!!!!!!!!!Navbar!!!!!!!!!!!!!!!!!  */}
        <div id='nav' className="w-fit  fixed top-5 left-1/2 -translate-x-1/2">
          <ul className='flex justify-center text-lg text-gray-500 py-1 bg-white shadow-lg rounded-full  px-8 gap-5  '>
            ...
            <a href='#projectsp' className='hover:text-black cursor-pointer hover:bg-gray-100 rounded-full py-1 px-4 transition-all ease-in duration-100 delay-100 '>Projects</a>
        ...
        <div id='home' className='flex flex-col items-center pt-20'>
          ...
          <p className='text-[36px]  font-bold mt-7'>Hello, I'm Sujal Paliwal </p>
          <p className='text-[36px]  text-red-500'>Full-Stack Developer</p>
          <p className='text-[36px] '>I love building website with</p>
          <p className='text-[36px]  underline font-medium'>React and Node.js</p>
          <div className="button mt-10 flex gap-4">
            <a href="#contact" className='border rounded-full px-4 py-2 text-xl bg-black text-white flex gap-3 items-center'>Contact me here<i class="fa-solid fa-arrow-right"></i></a>
            <a href="resume.pdf" target='_blank' download="SujalPaliwalResume.pdf" className='border rounded-full px-4 py-2 text-xl flex gap-3 items-center'>Download CV<i class="fa-solid fa-download"></i></a>
            <a href="https://www.linkedin.com/in/sujal-paliwal-a0a49927b" target='_blank' className='border rounded-full text-2xl flex items-center justify-center w-12 h-12'><i class="fa-brands fa-linkedin "></i></a>
            <a href="https://www.github.com/SUJALPALIWAL00" target='_blank' className='border rounded-full text-2xl flex items-center justify-center w-12 h-12'><i class="fa-brands fa-square-github"></i></a>
          </div>
        </div>
        ...
        {/* !!!!!!!!!!!!!!!!!!!!About Section!!!!!!!!!!!!!!!!!  */}
        <div id="about" className='flex flex-col items-center  w-[50vw] mx-auto'>
          <div className='font-bold text-3xl '>About Me</div>
          <div>
            <p className='text-[20px] text-center mt-5' >Hi, I'm <span class="font-semibold text-red-600">Sujal Paliwal</span> — a passionate and creative web developer with a strong foundation in front-end and back-end technologies. I enjoy turning ideas into functional and beautifully designed websites.</p>
            <p className='text-[20px] text-center mt-5' >Over time, I've developed hands-on experience with <span class="font-medium text-gray-900">HTML, CSS, JavaScript, Tailwind CSS, Bootstrap, React.js</span> and more. I’ve also started exploring backend technologies like <span class="font-medium text-gray-900">Node.js, Express.js, and MongoDB</span> to build full-stack applications.</p>
            <p className='text-[20px] text-center mt-5' >I'm constantly learning, building, and pushing my skills forward. My goal is to contribute to innovative projects, collaborate with talented teams, and create web experiences that make an impact.</p>
          </div>
        </div>


        {/* !!!!!!!!!!!!!!!!!!!!sepration!!!!!!!!!!!!!!!!!  */}
        <div id='projectsp' className="w-1 h-15 border border-gray-200 bg-gray-200 mx-auto shadow rounded-md my-20"></div>


        {/* !!!!!!!!!!!!!!! Projects Section !!!!!!!!!!!!!!! */}
        <div id="project" className='flex flex-col items-center w-[75vw] mx-auto'>
          <div className='font-bold text-3xl '>Projects</div>
          <div className="cards mt-10 grid grid-cols-3 gap-5">
        ...
        <div id="skills" className='flex flex-col items-center  w-[50vw] mx-auto '>
          ...
          <div className="skills grid grid-cols-4 gap-4 mt-10 w-[50vw]">
        ...
        {/* !!!!!!!!!!!!!!!!!!!!Experience Section!!!!!!!!!!!!!!!!!  */}
        <div id="experience" className='flex flex-col items-center  w-[70vw] mx-auto'>
          <div className='font-bold text-3xl '>Experience</div>
          <div className="internExperience text-[20px]">
        ...
        <div id="contact" >
          <div className='flex flex-col items-center  w-[40vw] mx-auto'>
            ...
            <div className="form w-full">
              <form action="https://formsubmit.co/mrpaliwal0011@gmail.com" method="POST" className='flex flex-col gap-4 mt-10 w-full'>
        ...
        <div className="footer bg-black text-white text-center py-5 relative">
          <p className='text-[20px]'>© 2025 Sujal Paliwal. All rights reserved.</p>
          <p className='text-[20px]'>Made with <i class="fa-solid fa-heart text-red-500"></i> by Sujal Paliwal</p>
          <a href="https://wa.me/+918079043867?text=Hello, I found your number from your personal portfolio website" target='_blank'><img src="whatsapp.svg" alt="" width="50px" className='absolute bottom-6 right-10'/></a>
        </div>
      </div>
    </>
  )
